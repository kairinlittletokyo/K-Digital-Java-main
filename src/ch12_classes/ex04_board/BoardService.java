...
//        ch13_map.ex02.BoardDTO boardDTO = new ch13_map.ex02.BoardDTO(boardTitle, boardWriter, boardPass, boardContents);
...
//
//    public void findAll() {
//        List<ch13_map.ex02.BoardDTO> boardDTOList = boardRepository.findAll();
...
//        // 2. 상세내용 가져옴
//        if (result) {
//            ch13_map.ex02.BoardDTO boardDTO = boardRepository.findById(id);
...
//        List<ch13_map.ex02.BoardDTO> searchList = boardRepository.search(q);
...
//    private void listPrint(List<ch13_map.ex02.BoardDTO> boardDTOList) {
//        System.out.println("id\t" + "title\t" + "writer\t" + "hits\t" + "date\t");
//        for (ch13_map.ex02.BoardDTO boardDTO: boardDTOList) {
...
//        for (int i = 1; i < 11; i++) {
//            ch13_map.ex02.BoardDTO boardDTO = new BoardDTO("title" + i, "writer" + i, "1234", "contents" + i);
