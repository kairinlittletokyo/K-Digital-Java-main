...
public class MemberService {
    ...
    MemberRepositoryList memberRepositoryList = new MemberRepositoryList();
    ...
    public void save() {
        ...
        do {
            ...
            checkResult = memberRepositoryList.emailCheck(memberEmail);
            if (checkResult) {
        ...
        boolean result = memberRepositoryList.save(memberDTO);
        if (result) {
    ...
    public void login() {
        ...
        System.out.print("비밀번호: ");
        String memberPassword = scanner.next();
        MemberDTO loginResult = memberRepositoryList.login(memberEmail, memberPassword);
        if (loginResult != null) {
    ...
    public void findAll() {
        List<MemberDTO> memberDTOList = memberRepositoryList.findAll();
    ...
    public void update() {
        if (loginEmail != null) {
            ...
            boolean result = memberRepositoryList.update(loginEmail, mobile);
            if (result) {
    ...
    public void delete() {
        if (loginEmail != null) {
            ...
            System.out.print("비밀번호: ");
            String memberPassword = scanner.next();
            MemberDTO memberDTO = memberRepositoryList.login(loginEmail, memberPassword);
            if (memberDTO != null) {
                boolean result = memberRepositoryList.delete(loginEmail);
                if (result) {
